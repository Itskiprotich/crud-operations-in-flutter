...
import 'package:crud/src/widgets/widgets.dart';
          ...
          child: Column(
            ...
            children: [
              AppTextField(
                ...
                decoration: inputDecoration(label: 'Enter Name', prefixText: ''),
              ),
              16.height,
              AppTextField(
                controller: jobCont,
                focus: jobFocusNode,
                textFieldType: TextFieldType.NAME,
                decoration: inputDecoration(label: 'Enter Job', prefixText: ''),
              ),
              16.height,
              AppButton(
